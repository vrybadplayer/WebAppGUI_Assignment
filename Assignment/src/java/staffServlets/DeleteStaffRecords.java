 ...
 * @author sumsn
 */
@WebServlet(name = "DeleteStaffRecords", urlPatterns = {"/DeleteStaffRecords"})
public class DeleteStaffRecords extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet DeleteStaffRecords</title>");
            out.println("</head>");
            out.println("<body>");
