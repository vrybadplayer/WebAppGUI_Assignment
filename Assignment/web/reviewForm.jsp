            ...
            <form method="POST" action="reviewServlet">
                ...
                <div class="form">
                    <div class="flex-row">
                        ...
                        <input type="text" name="Rating" placeholder="Rating 0.0~5.0" class="rating-input">
                    </div>
                    <div class="flex-row-dd">
                        <span class="review">Review:</span>
                        <input type="text" name="Commnet" placeholder="Enter your comment here" class="review-input">
                    </div>
