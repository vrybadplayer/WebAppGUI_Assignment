...
<html>
    ...
    <body>
        ...
        <div style="width: 516px; color: black; font-size: 40px; font-family: Ubuntu, sans-serif; font-weight: 600; line-height: 44px; word-wrap: break-word; margin-left: 765px; font-family: Ubuntu, sans-serif">Delete Staff</div>
        ...
        <form method="post" action="DeleteStaffRecords">
            <div style="width: 995px; height: 643px; position: relative; background: rgba(106, 53, 156, 0.70); box-shadow: 0px 4px 4px rgba(0, 0, 0, 0.25); border-radius: 79px; overflow: hidden; border: 1px rgba(106, 53, 156, 0.70) solid; margin-left: 400px; margin-top: 20px">
                ...
                <!--button-->
                    <button style="width: 86px; height: 40px; padding-left: 16px; padding-right: 16px; background: rgba(106, 53, 156, 0.70); border-radius: 8px; justify-content: center; align-items: center; gap: 8px; display: inline-flex; font-family: Ubuntu, sans-serif;color:white; margin-left:443px; margin-top:50px">Delete</button>
