<%-- 
    ...
    Created on : 13 Apr 2024, 9:48:08 PM
    Author     : sumsn
--%>
    ...
    <body style="overflow-y:auto; overflow-x:auto;max-height:113vh;white-space:nowrap; width:auto; height:112vh">
        ...
        <div style="width: 248px; height: 832px; position: relative; border-right: 1px #E0E0E0 solid; background: linear-gradient(to top, #fbc2eb 0%, #a6c1ee 100%)">
            <div style="height: 172px; left: 8px; top: 78px; position: absolute; flex-direction: column; justify-content: flex-start; align-items: flex-start; gap: 4px; display: inline-flex">
                ...
                <div style="margin-left:-8px; align-self: stretch; height: 40px; padding-left: 16px; padding-right: 16px; background: linear-gradient(to top, #cfd9df 0%, #e2ebf0 100%); border-radius: 8px; justify-content: flex-start; align-items: center; gap: 16px; display: inline-flex;">
        ...
        <!--Search Queries-->
        <form style="margin-top:-822px" action="StaffHomepage.jsp">
            ...
            <div style="width: 1234px; height: 707px; flex-direction: column; justify-content: flex-start; align-items: flex-start; display: inline-flex; padding-left: 280px">
                ...
                <div style="align-self: stretch; height: 56px; border-top: 1px #E0E0E0 solid; justify-content: flex-start; align-items: center; gap: 67px; display: inline-flex">
                    <div style="position:relative; margin-right:62px; top:-15px;">
                        <a href="DisplayStaffDetails.jsp?searchid=<%= individualStaff.getStaffid()%>" style="width: 70px; color: #828282; font-size: 16px; font-family: Ubuntu, sans-serif; font-weight: 500; line-height: 24px; word-wrap: break-word; position:absolute"><%= individualStaff.getStaffid()%></a>
                    </div>
                ...
                %>
                <div style="align-self: stretch; height: 56px; border-top: 1px #E0E0E0 solid; justify-content: flex-start; align-items: center; gap: 67px; display: inline-flex">
                    <form action="DisplayStaffDetails.jsp">
