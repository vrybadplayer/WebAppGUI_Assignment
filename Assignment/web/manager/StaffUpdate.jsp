<%-- 
    ...
    Created on : 20 Apr 2024, 2:30:06 PM
    Author     : sumsn
--%>
...
<!DOCTYPE html>
<html style="width:auto;margin:auto;height:auto">
    <head>
    ...
    <body style="overflow-y:auto; overflow-x:auto;max-height:113vh;white-space:nowrap; width:auto; height:112vh">
        <%
            try {
        ...
        <div style="width: 248px; height: 832px; position: relative; border-right: 1px #E0E0E0 solid; background: linear-gradient(to top, #fbc2eb 0%, #a6c1ee 100%)">
            ...
            <div style="margin-left:-8px;width: 208px; height: 40px; padding-left: 16px; padding-right: 16px; left: 8px; top: 250px; position: absolute; border-radius: 8px; justify-content: flex-start; align-items: center; gap: 16px; display: inline-flex;background: linear-gradient(to top, #cfd9df 0%, #e2ebf0 100%)">
        ...
        <!--Search Queries-->
        <form style="margin-top:-822px" action="StaffUpdate.jsp">
            ...
            %>
            <div style="width: 1234px; height: 707px; flex-direction: column; justify-content: flex-start; align-items: flex-start; display: inline-flex; padding-left: 280px">
                ...
                <div style="align-self: stretch; height: 56px; border-top: 1px #E0E0E0 solid; justify-content: flex-start; align-items: center; gap: 67px; display: inline-flex">
                    <div style="position:relative; margin-right:62px; top:-15px;">
                        <a href="UpdateStaffDetails.jsp?searchid=<%= individualStaff.getStaffid()%>" style="width: 70px; color: #828282; font-size: 16px; font-family: Ubuntu, sans-serif; font-weight: 500; line-height: 24px; word-wrap: break-word; position:absolute"><%= individualStaff.getStaffid()%></a>
                    </div>
                ...
                %>
                <div style="align-self: stretch; height: 56px; border-top: 1px #E0E0E0 solid; justify-content: flex-start; align-items: center; gap: 67px; display: inline-flex">
                    <form action="UpdateStaffDetails.jsp">
                ...
                <button name="prev" value="prev" style="width: 60px; height: 45px; padding-left: 24px; padding-right: 24px; padding-top: 14px; padding-bottom: 14px; background: linear-gradient(to top, #fbc2eb 0%, #a6c1ee 100%); box-shadow: 0px 1px 2px rgba(0, 0, 0, 0.05); border-radius: 8px; justify-content: center; align-items: center; gap: 8px; display: inline-flex; position:relative; right: -1064px; bottom:-23px;color: black; font-size: 16px; font-family: Ubuntu, sans-serif; font-weight: 500; line-height: 24px; word-wrap: break-word">Prev <</button>
                <button name="next" value="next" style="width: 60px; height: 45px; padding-left: 24px; padding-right: 24px; padding-top: 14px; padding-bottom: 14px; background: linear-gradient(to top, #fbc2eb 0%, #a6c1ee 100%); box-shadow: 0px 1px 2px rgba(0, 0, 0, 0.05); border-radius: 8px; justify-content: center; align-items: center; gap: 8px; display: inline-flex; position:relative; right: -1134px; bottom:21px;color: black; font-size: 16px; font-family: Ubuntu, sans-serif; font-weight: 500; line-height: 24px; word-wrap: break-word">Next ></button>
        </form>
    </div>
</body>
</html>
