<%-- 
    Document   : DisplayStaffDetails
    Created on : 19 Apr 2024, 3:57:01 PM
    Author     : sumsn
--%>
...
<html>
    ...
    <body>
        ...
        <!--Display Details-->
        <div style="width: 516px; color: black; font-size: 40px; font-family: Ubuntu, sans-serif; font-weight: 600; line-height: 44px; word-wrap: break-word; margin-left: 765px; font-family: Ubuntu, sans-serif;margin-top:-779px">Search Staff</div>
