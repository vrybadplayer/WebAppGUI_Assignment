<%-- 
    Document   : UpdateStaffDetails
    Created on : 20 Apr 2024, 2:35:17 PM
    Author     : sumsn
--%>
...
<html>
    ...
    <body>
        ...
        <!--Update Details-->
        <div style="width: 516px; color: black; font-size: 40px; font-family: Ubuntu, sans-serif; font-weight: 600; line-height: 44px; word-wrap: break-word; margin-left: 765px; font-family: Ubuntu, sans-serif;margin-top:-779px">Update Staff</div>
        ...
        %>
        <!--Form-->
        <form method="post" action="../UpdateStaffRecords">
            <div style="width: 995px; height: 643px; position: relative; background: linear-gradient(to top, #fbc2eb 0%, #a6c1ee 100%); box-shadow: 0px 4px 4px rgba(0, 0, 0, 0.25); border-radius: 79px; overflow: hidden; border: 1px rgba(106, 53, 156, 0.70) solid; margin-left: 400px; margin-top: 20px">
                ...
                <div style = "margin-top: 47px; margin-left: 69px">
                    <div style="width: 60px; height: 24px; flex-direction: column; justify-content: flex-start; align-items: flex-start; gap: 8px; display: inline-flex">
                        <div style="width: 60px; color: black; font-size: 16px; font-family: Ubuntu, sans-serif; font-weight: 500; line-height: 24px; word-wrap: break-word">Username: </div>
                    </div>
                </div>
                <!-- staff name -->
                ...
                <!--button-->
                    <button style="width: 86px; height: 40px; padding-left: 16px; padding-right: 16px; background: #DEEFF5; border-radius: 8px; justify-content: center; align-items: center; gap: 8px; display: inline-flex; font-family: Ubuntu, sans-serif;color:black; margin-left:443px; margin-top:50px">Update</button>
