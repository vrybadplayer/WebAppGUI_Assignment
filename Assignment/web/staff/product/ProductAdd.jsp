...
<html>
    ...
    <body>
        ...
        <div style="width: 248px; height: 1082px; position: absolute; background: linear-gradient(to top, #fbc2eb 0%, #a6c1ee 100%); border-right: 1px #E0E0E0 solid">
            ...
            <div style="margin-left:-8px;width: 216px; height: 40px; padding-left: 16px; padding-right: 16px; left: 8px; top: 250px; position: absolute; border-radius: 8px; justify-content: flex-start; align-items: center; gap: 16px; display: inline-flex">
